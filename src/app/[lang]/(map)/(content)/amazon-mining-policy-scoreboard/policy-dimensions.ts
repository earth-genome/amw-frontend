...
export const POLICY_DIMENSIONS: PolicyDimension[] = [
  ...
  },
  {
    ...
    desc_pt: [
      "A dimensão de Investigação e aplicação da lei mede a capacidade de um país para detectar, investigar e punir a mineração ilegal de ouro e as redes criminosas por trás dela. Isso vai além de ter leis vigentes, pergunta se existem unidades de fiscalização especializadas com alcance real, se a cadeia de suprimento de ouro é rastreável da mina ao mercado, e se o judiciário se envolveu de forma significativa com os danos ambientais relacionados à mineração.",
